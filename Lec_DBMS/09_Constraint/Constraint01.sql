...
CREATE TABLE T_MEMBER (
    ...
    MB_AGE NUMBER,
    MB_DEPT NUMBER,
    CONSTRAINT T_MEMBER_PK PRIMARY KEY (MB_UID),
    CONSTRAINT T_MEMBER_UN UNIQUE (MB_JUMIN),
    CONSTRAINT T_MEMBER_UN CHECK(MB_AGE > 0),
    CONSTRAINT FK_T_DEPT FOREIGN KEY (MB_DEPT) REFERENCES T_DEPT(DEPTNO)
);
...
INSERT INTO T_NOVALIDATE values(1,'ddd'); --처음에는 오류 pk니까
