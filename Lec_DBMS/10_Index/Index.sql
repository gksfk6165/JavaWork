...
SELECT EMPNO ,rowid FROM t_emp;
SELECT EMPNO ,rowid FROM t_emp ORDER BY 1 desc;
SELECT ENAME ,rowid FROM t_emp;
...
INSERT INTO t_dept2 values(9101,'임시매장',1006,'부산지사'); --SQL Error [1] [23000]: ORA-00001: unique constraint (SCOTT0316.IDX_DEPT2_DNAME) violated
...
CREATE INDEX idx_prof_position ON T_PROFESSOR(POSITION DESC);
