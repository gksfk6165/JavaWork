...
public class Operator01Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("실수나누기결과 :  "+result2);
		...
		System.out.println("나머지 연산결과:  "+result3);
		...
		int num4=200;
		int temp=0;//임시변수
		System.out.println("바꾸기전  "+num3+" @@@ "+num4);
		
		temp=num3;
		num3=num4;
		num4=temp;
		
		System.out.println("바꾸면  "+num3+" @@@ "+num4);
		...
		num6=num5=300;
		System.out.println(num6+"  ㅡㅡ     "+num5);
