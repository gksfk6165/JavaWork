...
public class UrlEncodeMain {
	public static void main(String[] args) {
		System.out.println("url 인코딩 , 디코딩");
		...
		System.out.println();
		String encUtf8="%ED%8C%8C%EC%9D%B4%EC%8D%AC";
		
		try {
			String d=URLDecoder.decode(encUtf8,"UTF-8");
			String d2=URLDecoder.decode(encUtf8,"euc-kr");
