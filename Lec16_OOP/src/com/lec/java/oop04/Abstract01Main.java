...
public class Abstract01Main {
	...
	public static void main(String[] args) {
		...
		//추상클래스는 인스턴스생성불가능
		//TestAbstarct test1=new TestAbstarct();//에러
...
//추상클래스를 상속받는 클래스는 반드시추상메소드를 구현 해야함
//추상메소드의 본체 ({...})를 만들어줘야함
class TestClass extends TestAbstarct{
...
abstract class TestClass2 extends TestAbstarct{
	int number;
}
