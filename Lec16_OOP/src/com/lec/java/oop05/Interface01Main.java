...
public class Interface01Main {
	...
	public static void main(String[] args) {
		...
		//System.out.println(test1.MIN);  //모호성에러
		//System.out.println(test2.MIN)//모호성에러
...
//인터페이스는 특별한 종류에 추상클래스
//2. 모든 멤버 변수가 public static final로 선언된 특별한 종류의 추상 클래스
...
interface TestInterface{
	...
	void testBBB();  //public abstract생략가능
}
//인터페이스는 인스턴스를 생성할수없고
//다른클래스에서 구현 해야함
