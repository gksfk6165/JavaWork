...
public class String02Main {
	...
	public static void main(String[] args) {
		...
		if(str3.equals(str4)) {
			System.out.println("equals()같은문자열");
		}else {
			System.out.println("equals()다른문자열");
		}
		System.out.println();
		System.out.println("[5] String intern() 메소드");
		
		if(str3.intern()==str4.intern()) {
			System.out.println("intern()동일참조");
		}else {
			System.out.println("intern()다른곳참조");
		}
